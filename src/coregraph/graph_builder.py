...
class GraphBuilder:
    ...
    def build_from_entities_and_relationships(self, entities: List[Dict[str, Any]], relationships: List[Dict[str, Any]]) -> None:
    ...
    def _get_node_type_counts(self) -> Dict[str, Any]:
        type_counts = {}
    ...
    def add_entities_and_relationships_incrementally(self, entities: List[Dict[str, Any]], relationships: List[Dict[str, Any]]) -> None:
